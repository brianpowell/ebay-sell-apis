...
module.exports = {
	...
	/*
        ...
        Default:
            ...
            pickupDropOff = false
    */
    buildFulfillmentPolicy: function ( fulfill, handlingTime, fullPaymentDueIn, paymentMethods ) {
    ...
    */
    buildShippingOptions: function ( costType, optionType, insuranceOffered, insuranceFee, packageHandlingCost, shippingServices ) {
    ...
    /* 
        ...
        Defaults:
            ...
            sortOrder = 1
    */
    buildShippingService: function ( ship, additionalShippingCost, cashOnDeliveryFee, shippingCost, shipToLocations, surcharge ) {
	...
	/* 
        ...
        Defaults:
            insuranceOffered = false
    */
    buildShipToLocation: function ( regionExcluded, regionIncluded ) {
