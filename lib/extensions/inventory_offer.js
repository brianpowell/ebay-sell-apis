...
module.exports = {
    ...
    */
    buildOffer: function ( offer, listingPolicies, pricingSummary, tax ) {
    ...
    */
    buildPricingSummary: function (  price, originallySoldForRetailPriceOn, pricingVisibility, originalRetailPrice, minimumAdvertisedPrice ) {
