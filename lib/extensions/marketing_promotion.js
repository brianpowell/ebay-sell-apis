...
module.exports = {
	...
	/*
        ...
        Default:
    */
    buildPromotion: function ( promo, discountRules, inventoryCriterion ) {
    ...
    /* 
        ...
        Default:
        	ruleOrder = 1
    */
    buildDiscountRule: function ( ruleOrder, discountBenefit, discountSpecification ) {
    ...
    */
	buildDiscountBenefit: function ( amountOffItem, amountOffOrder, percentageOffItem, percentageOffOrder ) {
    ...
    */
	buildDiscountSpecification: function ( forEachAmount, forEachQuantity, minAmount ) {
    ...
    */
    buildInventoryCriterion: function ( inventoryCriterionType, listingIds, inventoryItems ) {
