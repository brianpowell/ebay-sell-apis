...
module.exports = {
    ...
    */
    ...
    // Shorthand Hours
    buildOperatingHours: 	function ( day_val, intervals ) { return _buildHour( "operating", day_val, intervals ); },
    buildSpecialHours: 		function ( day_val, intervals ) { return _buildHour( "special", day_val, intervals ); },
