...
module.exports = function( enums ) {
    ...
    */
    function _buildLocation ( location, address, locationType, operatingHours, specialHours ) {
    ...
    */
    function _buildAddress ( address, geoLoc ) {
    ...
    */
    function _buildHour ( type, day_val, intervals ) {
    ...
    */
    function _buildInterval ( open, close ) {
    ...
    return {
        ...
        buildHour:      _buildHour,
        buildInterval:  _buildInterval  
    }
}